<div  id="top">
	...
	<div id="menu">
			<ul>
				...
				<li><a href="posts.php">Bài Viết</a>
				</li>
	...
	<marquee behavior="alternate" direction="right" id="marquee"><font color="red">&hearts; </font>Trang web hiện đang xây dựng giao diện cho mobi. Sẽ hoàn thiện sớm trong dự định <font color="red">&hearts; </font></marquee>